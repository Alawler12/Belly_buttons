...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    //my questions: what makes this the top 10, rather then just a random 10?  where have i sorted them?  doesn't slice just slice a section out?  
    //this implies that the array was already in order; I don't remember putting it in order.
